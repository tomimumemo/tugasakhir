	...
	<section class="product-area shop-sidebar shop-list shop section">
		...
		<div class="col-lg-9 col-md-8 col-12">
			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-6 col-12">
							<div class="list-content">
								...
								<a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">Beli!</a>
							</div>
						</div>
					</div>
				</div>
				...
				@endforeach
				@else
				<h4 class="text-warning" style="margin:100px auto;">Tidak ada produk saat ini.</h4>
				@endif
			</div>
			<div class="row">
