...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2022 at 01:14 PM
...
(18, 9, 3, 3, 38000.00, 'delivered', 1, 38000.00, '2022-04-10 12:22:56', '2022-04-15 23:02:52'),
(19, 8, 3, 3, 50000.00, 'new', 1, 50000.00, '2022-04-10 12:23:00', '2022-04-10 12:25:16'),
(20, 6, NULL, 3, 135800.00, 'new', 1, 135800.00, '2022-04-14 21:06:06', '2022-04-14 21:06:06');
...
(1, 'Alfain Azzaria Bustami', 'admin@gmail.com', NULL, '$2y$10$euubUBAOabQ3Ru3ehQaZHuf/GD2j8.lW9MwJYjtdV4SXtJSqsoi9O', '/storage/photos/1/users/user1.jpg', 'admin', NULL, NULL, 'active', 'pNL1k6Pi5VWTYUstyAtoWX9PIhAamyGje16zD2Hs03Nhv6ZfSYKmuRev4Pt8', NULL, '2022-03-31 00:12:35', '2022-03-31 00:12:35'),
(2, 'Bening Ramadan M K', 'penjual@gmail.com', NULL, '$2y$10$LAFAVQy.zg.zB.7oEZz61OBSuTrUjV4CIPTBcqnllRYGhvKcB7Ww2', NULL, 'pelapak', NULL, NULL, 'active', NULL, NULL, '2022-04-01 03:19:18', '2022-04-16 04:04:28'),
(3, 'pembeli', 'pembeli@gmail.com', NULL, '$2y$10$EJyZ6j8RTxPZEp5Oq/tLFOmyOUYg9tI/9kAvZ6IuS1erLKoN0JyzK', NULL, 'user', NULL, NULL, 'active', NULL, 1, '2022-04-10 01:45:41', '2022-04-16 01:06:06');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `detail_order`  AS SELECT `c`.`title` AS `title`, `b`.`price` AS `price`, `c`.`photo` AS `photo`, `c`.`id_penjual` AS `id_penjual`, `b`.`quantity` AS `qty`, `b`.`price`* `b`.`quantity` AS `total`, `b`.`product_id` AS `id_product`, `d`.`name` AS `nama_penjual` FROM (((`orders` `a` join `carts` `b` on(`a`.`id` = `b`.`order_id`)) join `products` `c` on(`b`.`product_id` = `c`.`id`)) join `users` `d` on(`c`.`id_penjual` = `d`.`id`)) WHERE `a`.`payment_status` = 'paid''paid'  ;
...
--
-- Indexes for table `pengajuan_pelapak`
--
ALTER TABLE `pengajuan_pelapak`
...
--
-- AUTO_INCREMENT for table `pengajuan_pelapak`
--
ALTER TABLE `pengajuan_pelapak`
